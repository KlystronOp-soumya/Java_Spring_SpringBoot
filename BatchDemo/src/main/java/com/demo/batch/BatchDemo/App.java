...
public class App {
	...
	private static String getBatchRunDate() {
		...
		final String formattedDate = String.format(formatString, Integer.toString(y), Integer.toString(m),
				Integer.toString(d));
	...
	public static void main(String[] args) {
		...
		JobLauncher jobLauncher = (JobLauncher) context.getBean("jobLauncher"); // Autowiring in the main class not
																				// possible
