...
quarkus create app \
"com.demo.azure:azure-func-trigger:1.0.0-SNAPSHOT" \
--maven --java=17 \
--name azure-func-trigger \
...
You can then execute your native executable with: `./target/azure-func-trigger-1.0.0-SNAPSHOT-runner`
