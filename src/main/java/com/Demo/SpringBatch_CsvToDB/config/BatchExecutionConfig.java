...
/*
 * This Class Configures JobLauncher,DataSource,File
 * 
 * */
@Configuration
@ComponentScan(basePackages = "com.Demo.SpringBatch_CsvToDB")
...
public class BatchExecutionConfig {
	...
	public ThreadPoolTaskExecutor threadPoolTaskExecutor() {
		...
		threadPoolTaskExecutor.setThreadGroupName("CSV_TO_DB_THREADS");
